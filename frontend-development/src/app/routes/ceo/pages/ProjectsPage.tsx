    ...
    <div className="space-y-6">
      ...
      {projectsWaitingPM.length > 0 && (
        <Alert>
          ...
          <AlertTitle>Perhatian CEO!</AlertTitle>
          <AlertDescription>
            Ada {projectsWaitingPM.length} project yang belum di-assign PM.
            CEO hanya bisa assign PM untuk layanan WEB DEV.
          </AlertDescription>
        </Alert>
      )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>CEO hanya bisa assign PM untuk layanan WEB DEV</CardDescription>
        </CardHeader>
        <CardContent>
                    ...
                    return (
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-2">
                          {/* CEO: Assign PM only for WEB DEV */}
      ...
      <Dialog open={isAssignPMOpen} onOpenChange={setIsAssignPMOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              CEO memilih PM untuk project: {selectedProject?.serviceName}
            </DialogDescription>
          </DialogHeader>
