...
export interface FormChannelLink {
  id: string;
...
export interface Form {
  ...
  publicQrUrl?: string;
  /** Optional per-channel links (e.g. instagram/linkedin) generated by backend when published. */
  channelLinks?: FormChannelLink[];
  createdBy: string;
  createdAt: string;
  updatedAt: string;
  publishedAt?: string;
...
export interface BankDataEntry {
  ...
  /** Which public slug was used when submitting (e.g. form-xxx-instagram / form-xxx-linkedin). */
  entrySlug?: string;
  campaignName: string;
