...
interface DocumentItem {
  ...
  file?: File;
  fileUrl?: string;
  uploadedAt?: string; // For internal state management
  uploadedBy?: string; // User ID or name who uploaded the document (for backend integration)
  uploadDate?: string; // ISO date string when document was uploaded (for backend integration)
}
...
export function ClientDocumentsSection({
  ...
  const handleFileUpload = (index: number, file: File) => {
    ...
    newDocuments[index] = {
      ...
      uploadedAt: now, // For internal state
      uploadedBy: 'Current User', // TODO: Replace with actual user from auth context
      uploadDate: now // For backend integration
    };
    onDocumentsReceivedChange(newDocuments);
  };
