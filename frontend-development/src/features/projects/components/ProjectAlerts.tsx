...
export function ProjectAlerts({
  ...
  const hasAnyAlert = projectsWaitingPM > 0 || projectsWaitingPayment > 0 || projectsOverdue > 0 || projectsAtRisk > 0;
    ...
    <div className="space-y-4">
      ...
      {projectsWaitingPM > 0 && (
        <Alert>
          ...
          <AlertDescription>
            {alertDescription || `Ada ${projectsWaitingPM} project yang belum di-assign PM.`}
          </AlertDescription>
        </Alert>
      )}
      ...
      {projectsWaitingPayment > 0 && (
        <Alert>
          ...
          <AlertDescription>
            Ada {projectsWaitingPayment} project menunggu pembayaran 50% sebelum bisa dimulai PM.
          </AlertDescription>
        </Alert>
      )}
      ...
      {projectsOverdue > 0 && (
        <Alert className="border-red-500 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            Ada {projectsOverdue} project yang sudah melewati deadline. Segera selesaikan project ini!
          </AlertDescription>
        </Alert>
      )}
      ...
      {projectsAtRisk > 0 && (
        <Alert className="border-orange-500 bg-orange-50">
          ...
          <AlertDescription className="text-orange-800">
            Ada {projectsAtRisk} project yang sudah dekat deadline namun progress masih di bawah 100%.
