...
export interface LeadInboxPaginationProps {
  currentPage: number;
  totalPages: number;
  itemsPerPage: number;
  totalItems: number;
...
export function LeadInboxPagination({
  currentPage,
  totalPages,
  itemsPerPage,
  totalItems,
  ...
  return (
    <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between bg-white">
      ...
      <div className="flex gap-2">
        ...
        <button
          type="button"
          className="h-8 px-3 rounded-md bg-white text-black border border-black text-sm font-medium"
